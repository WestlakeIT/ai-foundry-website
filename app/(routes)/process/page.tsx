    ...
    <div className="bg-[#0a0a0f] text-white overflow-x-hidden">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden" style={{ background: 'radial-gradient(circle at center, #0d1b2a 0%, #0a0a0f 100%)' }}>
        ...
        <div className="text-center z-10 animate-fadeInUp">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-5 bg-gradient-to-br from-[#00f5ff] via-[#00ff88] to-[#9d4edd] bg-clip-text text-transparent">
            The Story of 90 Days
          </h1>
      ...
      {/* Problem Section */}
      <section className="min-h-screen flex items-center py-20 px-5 bg-gradient-to-br from-[#1a0d2e] via-[#2d1b4e] to-[#0d1b2a]">
        <div className="max-w-[1200px] mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl mb-8 text-transparent bg-clip-text bg-gradient-to-r from-[#ff00ff] to-[#ff1493] font-bold">
                The Industry Problem
              </h2>
              <ul className="space-y-5">
                <li 
                  ref={(el) => { if (el) painPointsRef.current[0] = el; }}
                  className="flex items-center p-5 bg-[rgba(255,0,255,0.15)] border-l-4 border-[#ff00ff] rounded-lg backdrop-blur-sm"
                >
            ...
            <div className="relative h-[500px] flex items-center justify-center">
              <div className="absolute top-[10%] left-[10%] p-4 bg-[rgba(255,0,255,0.25)] border-2 border-[#ff00ff] rounded-lg animate-float text-cyan-200 font-semibold shadow-[0_0_20px_rgba(255,0,255,0.5)]">
                6 Months?
              </div>
              <div className="absolute top-[20%] right-[20%] p-4 bg-[rgba(255,20,147,0.25)] border-2 border-[#ff1493] rounded-lg animate-float text-cyan-200 font-semibold shadow-[0_0_20px_rgba(255,20,147,0.5)]" style={{ animationDelay: '0.5s' }}>
                $500K Budget
              </div>
              <div className="absolute bottom-[30%] left-[15%] p-4 bg-[rgba(157,78,221,0.25)] border-2 border-[#9d4edd] rounded-lg animate-float text-cyan-200 font-semibold shadow-[0_0_20px_rgba(157,78,221,0.5)]" style={{ animationDelay: '1s' }}>
                Maybe Q3?
              </div>
              ...
              <div className="absolute top-[50%] left-[40%] p-4 bg-[rgba(0,255,136,0.25)] border-2 border-[#00ff88] rounded-lg animate-float text-cyan-200 font-semibold shadow-[0_0_20px_rgba(0,255,136,0.5)]" style={{ animationDelay: '2s' }}>
                Team Unknown
              </div>
            </div>
          </div>
      ...
      {/* Solution Section */}
      <section className="min-h-screen flex items-center py-20 px-5 bg-gradient-to-b from-[#0d1b2a] to-[#1a0d2e]">
        <div className="max-w-[1200px] mx-auto w-full">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl mb-5 bg-gradient-to-br from-[#00f5ff] via-[#00ff88] to-[#9d4edd] bg-clip-text text-transparent font-bold">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 my-20">
            <div className="flex-1 p-10 rounded-3xl bg-[rgba(255,0,255,0.15)] border-2 border-dashed border-[rgba(255,0,255,0.4)] text-center backdrop-blur-sm">
            ...
            <div className="flex-1 p-10 rounded-3xl bg-gradient-to-br from-[rgba(0,245,255,0.2)] via-[rgba(0,255,136,0.15)] to-[rgba(157,78,221,0.2)] border-2 border-[rgba(0,245,255,0.5)] text-center backdrop-blur-sm shadow-[0_0_30px_rgba(0,245,255,0.3)]">
              <div className="text-6xl mb-5">🚀</div>
              <div className="text-2xl mb-4 font-semibold text-cyan-200">After 90 Days</div>
              <div className="text-cyan-100/80">
      ...
      <section className="py-24 px-5" style={{ background: 'radial-gradient(ellipse at top, #0d1b2a 0%, #0a0a0f 100%)' }}>
        <div className="max-w-[1200px] mx-auto w-full">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl mb-5 font-bold bg-gradient-to-r from-[#00f5ff] to-[#9d4edd] bg-clip-text text-transparent">The 90-Day Journey</h2>
            <p className="text-cyan-300 text-xl">Every day counts. Every phase matters.</p>
          </div>

          <div className="relative py-16">
            <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-[#00f5ff] via-[#00ff88] via-[#9d4edd] to-transparent opacity-50" />
            <div className="flex flex-col lg:flex-row justify-between relative">
              {journeyStages.map((stage, index) => {
                const auroraColors = [
                  'from-[#00f5ff] to-[#00d9ff]',
                  'from-[#00ff88] to-[#39ff14]',
                  'from-[#9d4edd] to-[#7209b7]',
                  'from-[#00ccff] to-[#0099ff]',
                  'from-[#ff00ff] to-[#ff1493]'
                ];
                return (
                  <div key={index} className="flex-1 text-center relative mb-16 lg:mb-0">
                    ...
                    >
                      <div className={`absolute -top-[30px] left-1/2 transform -translate-x-1/2 w-16 h-16 bg-gradient-to-br ${auroraColors[index]} rounded-full flex items-center justify-center text-xl font-bold text-white shadow-[0_0_20px_rgba(0,245,255,0.6)]`}>
                        {String(index + 1).padStart(2, '0')}
                      </div>
                      <div className="text-5xl mb-5">{stage.icon}</div>
      ...
      {/* Benefits Section */}
      <section className="py-24 px-5 bg-gradient-to-br from-[#1a0d2e] via-[#0d1b2a] to-[#2d1b4e]">
        <div className="max-w-[1200px] mx-auto w-full">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl mb-5 font-bold bg-gradient-to-r from-[#00f5ff] to-[#ff00ff] bg-clip-text text-transparent">Why This Changes Everything</h2>
            <p className="text-cyan-300 text-xl">The 90-day guarantee isn&apos;t just a timeline—it&apos;s a promise</p>
          </div>
      ...
      <section className="min-h-[60vh] flex items-center justify-center text-center py-20 px-5" style={{ background: 'radial-gradient(circle at center, #0d1b2a 0%, #0a0a0f 100%)' }}>
        <div>
          <h2 className="text-4xl md:text-5xl mb-8 bg-gradient-to-br from-[#00f5ff] via-[#00ff88] to-[#9d4edd] bg-clip-text text-transparent font-bold">
          ...
          <Link 
            href="/start-building"
            className="inline-block px-12 py-5 bg-gradient-to-br from-[#00f5ff] via-[#00ff88] to-[#9d4edd] text-white rounded-full text-xl font-semibold transition-all hover:-translate-y-1 shadow-[0_10px_30px_rgba(0,245,255,0.4)] hover:shadow-[0_15px_40px_rgba(0,245,255,0.6)] hover:scale-105"
          >
...
const journeyStages = [
  ...
  },
  {
    icon: '🏗️',
    title: 'Days 15-30',
    description: 'Foundation phase: Infrastructure spins up, data pipelines flow, and your AI begins to take shape. Everything is version-controlled and documented.'
  },
  {
    icon: '⚡',
    title: 'Days 31-60',
    description: 'The building sprint: AI models train, APIs develop, frontends emerge. Daily standups keep everyone aligned and progress visible.'
  },
  {
    icon: '💎',
    title: 'Days 61-75',
    description: 'Refinement phase: Real users test, performance optimizes, security hardens. Your product transforms from good to exceptional.'
  },
  {
    icon: '🎉',
    title: 'Days 76-90',
    description: 'Launch ready: Production deployment, monitoring setup, team training. You\'re not just getting software, you\'re getting a complete solution.'
  }
];
